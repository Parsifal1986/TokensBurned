...
const harnesses = {
  ...
  gemini: {
    ...
    title: "Gemini CLI",
    confidence: "Recorded usage and history",
    summary: "Collect recorded Gemini usage with the background CLI, including supported child sessions.",
    steps: ["Install the CLI", "Connect GitHub", "Start Gemini collection"],
    command: "npm install -g tokensburned\ntokensburned connect\ntokensburned run --harness gemini-cli",
    note: "Use backfill --harness gemini-cli --dry-run to preview retained history. See the collection guide for supported versions.",
  },
  copilot: {
    status: "LIVE EXTENSION",
    title: "GitHub Copilot CLI",
    confidence: "Live per-call usage",
    summary: "The live extension records usage in compatible Copilot CLI sessions, including subagents.",
    steps: ["Install and connect the CLI", "Install the live extension", "Start a new Copilot session"],
    command: "npm install -g tokensburned\ntokensburned connect\ntokensburned integrations install copilot\ncopilot --experimental",
    note: "Check /extensions manage. Usage from before the extension started cannot be recovered from ordinary history.",
  },
  cline: {
    status: "PLUGIN + CLI",
    title: "Cline",
    confidence: "Supported SDK and IDE records",
    summary: "Collect usage through the Cline plugin or supported SDK and classic IDE histories.",
    steps: ["Install the CLI", "Connect GitHub", "Start Cline collection"],
    command: "npm install -g tokensburned\ntokensburned connect\ntokensburned run --harness cline",
    note: "Use the same connection and data directory for the CLI and plugin to avoid duplicate collection.",
  },
  opencode: {
    status: "LOCAL COLLECTOR",
    title: "OpenCode",
    confidence: "SQLite and legacy JSON",
    summary: "Collect finalized OpenCode usage from supported SQLite databases and legacy JSON histories.",
    steps: ["Install the CLI and sqlite3", "Connect GitHub", "Start OpenCode collection"],
    command: "npm install -g tokensburned\ntokensburned connect\ntokensburned run --harness opencode",
    note: "Supports v1/v2 database formats and retained message JSON. See the collection guide for custom paths.",
  },
  other: {
