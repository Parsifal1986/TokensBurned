...
- Explain that the user must manually enter the short code, verify the displayed device name, and confirm before GitHub authorization. Never ask them to use a code supplied by someone else.
